...
public class PlayroomEntityTypeTagProvider extends FabricTagProvider.EntityTypeTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        this.getOrCreateTagBuilder(Tags.IMMUNE_TO_FREEZE).add(EntityType.ENDER_DRAGON, EntityType.WARDEN, EntityType.WITHER, EntityType.STRAY, EntityType.ARMOR_STAND);
    }
}
