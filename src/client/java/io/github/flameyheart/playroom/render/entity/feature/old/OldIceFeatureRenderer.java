package io.github.flameyheart.playroom.render.entity.feature.old;
...
public class OldIceFeatureRenderer<T extends LivingEntity, M extends EntityModel<T>> extends FeatureRenderer<T, M> {
    public OldIceFeatureRenderer(LivingEntityRenderer<T, M> context) {
        super(context);
    }
